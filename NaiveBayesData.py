...
print(f"\nDistribuição das previsões: {np.bincount(y_pred)}")
...
print("\nModelo GaussianNB (features contínuas):")
print(f"Classes: {model.gn.classes_}")
print(f"Médias por classe: {model.gn.theta_.shape}")
...
print(f"Previsão para nova amostra: {predicao_nova[0]}")
